        ...
        btnTweet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(tweetContent.isEmpty()){
                    Toast.makeText(ComposeActivity.this, "Tweet cannot be empty, Type Something to post!",Toast.LENGTH_SHORT).show();
                    return;
                }
                else if(tweetContent.length() > MAX_TWEET_LIMIT){
                    Toast.makeText(ComposeActivity.this, "Tweet exceeds the character limit!",Toast.LENGTH_SHORT).show();
                    return;
                }
